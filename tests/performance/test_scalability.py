...
class TestScalabilityPerformance:
    ...
    def test_dataflow_parsing_performance(self, temp_dir):
        ...
        try:
            ...
            assert dataflows_per_second > 30  # Should process at least 30 dataflows/second
    ...
    def test_memory_usage_scaling(self, temp_dir):
        ...
        for i in range(1, len(memory_usage)):
            ...
            memory_ratio = memory_usage[i]['memory_used_mb'] / max(memory_usage[i-1]['memory_used_mb'], 1)
    ...
    def test_file_io_performance(self, temp_dir):
        ...
        for format_type, results in performance_results.items():
            ...
            assert results['file_size_mb'] < 100  # Should be less than 100MB for 10k rows
        
        # Parquet should be fastest for large datasets
        assert performance_results['parquet']['write_time'] < performance_results['excel']['write_time']
        assert performance_results['parquet']['read_time'] < performance_results['excel']['read_time']
    ...
    def test_categorization_performance(self):
        ...
        assert datasets_per_second > 1000  # Should process at least 1000 datasets/second
    ...
    def test_stress_test_api_endpoints(self, mock_requests_session):
        ...
        def mock_response(*args, **kwargs):
            ...
            response.elapsed.total_seconds.return_value = response_times.pop(0) if response_times else 0.5
            return response
    ...
    def _generate_large_dataflow_xml(self, num_dataflows):
        ...
        categories = ['popolazione', 'economia', 'lavoro', 'territorio', 'istruzione', 'salute']
