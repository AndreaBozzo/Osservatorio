...
</message:StructureSpecificData>'''.format(timestamp=datetime.now().isoformat())
...
</message:GenericData>'''.format(timestamp=datetime.now().isoformat()),
    ...
    <message:Structures>
        ...
        def get_dataset_data(dataset_id):
            ...
            dataset_xml = self.mock_datasets.get(
                dataset_id, 
                self.mock_datasets["TEST_DATASET"]
            )
