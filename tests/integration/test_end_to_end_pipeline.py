...
class TestEndToEndPipeline:
    ...
    def test_complete_tableau_pipeline(self, temp_dir, sample_dataflow_xml, sample_xml_data):
        ...
        with patch('requests.Session') as mock_session:
            ...
            try:
                ...
                # Find top dataflows
                top_dataflows = analyzer.find_top_dataflows_by_category(categorized, top_n=2)
                ...
                with patch.object(analyzer, '_test_single_dataflow') as mock_test:
                    ...
                    tested = analyzer.test_priority_dataflows(top_dataflows, max_tests=5)
    ...
    def test_complete_powerbi_pipeline(self, temp_dir, sample_converted_data):
        ...
        for format_type in formats:
            ...
            if format_type == 'csv':
                ...
                test_data.to_json(output_file, orient='records', indent=2, force_ascii=False)
    ...
    def test_data_quality_pipeline(self, temp_dir, sample_converted_data):
        ...
        test_data = pd.concat([test_data, test_data.iloc[0:1]], ignore_index=True)  # Duplicate
    ...
    def test_scalability_pipeline(self, temp_dir):
        ...
        sorted_datasets = sorted(datasets, key=lambda x: analyzer._calculate_priority(x), reverse=True)
        
        # Higher index datasets should have higher priority
        assert analyzer._calculate_priority(sorted_datasets[0]) >= analyzer._calculate_priority(sorted_datasets[-1])
