...
class TestIstatDataflowAnalyzer:
    ...
    def test_suggest_tableau_connection(self):
        ...
        assert (
            analyzer._suggest_tableau_connection(large_dataflow) == "bigquery_extract"
        )
        ...
        assert (
            analyzer._suggest_tableau_connection(medium_dataflow)
        ...
        assert (
            analyzer._suggest_tableau_connection(small_dataflow) == "direct_connection"
        )
    ...
    def test_parse_dataflow_xml_success(self, mock_parse, mock_file):
        ...
        with patch.object(
            ...
            with patch.object(
                analyzer,
                "_categorize_dataflows",
                return_value={"popolazione": [{"id": "101_12"}]},
            ):
    ...
    def test_create_tableau_ready_dataset_list(self, capsys):
        ...
        tested_dataflows = [
            ...
            },
            {
                ...
                "category": "economia",
                "relevance_score": 9,
                "tests": {"data_access": {"success": False, "size_bytes": 0}},
            },
        ]
